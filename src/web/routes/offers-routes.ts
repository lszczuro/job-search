...
export function renderOffersList(offers: OfferListItem[], refreshMeta: RefreshMeta) {
  return [
    ...
    ".secondary-button{border:1px solid #d6d3d1;border-radius:999px;background:#fafaf9;color:#1f2937;padding:7px 12px;font-size:13px;font-weight:600;cursor:pointer;}",
    ".secondary-button[disabled]{color:#a8a29e;cursor:not-allowed;}",
    ...
    ".modal-card{width:min(100%,520px);background:#fffdf8;border:1px solid #d6d3d1;border-radius:24px;box-shadow:0 24px 80px rgba(15,23,42,.16);padding:24px;}",
    ".modal-card h2{margin:0 0 16px;font-size:24px;}",
    ".manual-form{display:grid;gap:14px;}",
    ".manual-form label{display:grid;gap:6px;font-size:14px;font-weight:600;color:#44403c;}",
